...
case "$1" in
   ...
   "init")
      if [ -f "$GENESIS_PATH" ]; then
          ...
          secrets=$("$GITSHOCK_CHAIN_BIN" secrets init --num 4 --data-dir data- --json)
          echo "Secrets have been successfully generated"

          echo "Generating genesis file..."
          "$GITSHOCK_CHAIN_BIN" genesis \
            --dir "$GENESIS_PATH" \
            --consensus ibft \
   ...
   *)
      ...
      echo "Executing gitshock-chain..."
      exec "$GITSHOCK_CHAIN_BIN" "$@"
      ;;
