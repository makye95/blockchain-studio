...
import (
	...
	"github.com/gitshock-labs/go-client/command/server/config"
	"github.com/gitshock-labs/go-client/command/server/export"
...
func GetCommand() *cobra.Command {
	serverCmd := &cobra.Command{
		Use:     "server",
		Short:   "The default command that starts the Gitshock Edgeware client, by bootstrapping all modules together",
		PreRunE: runPreRun,
		Run:     runCommand,
	}
...
func setFlags(cmd *cobra.Command) {
	...
	cmd.Flags().StringVar(
		...
		"the data directory used for storing Gitshock Edgeware client data",
	)
