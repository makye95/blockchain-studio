...
import (
	...
	"github.com/gitshock-labs/go-client/command/peers/add"
	"github.com/gitshock-labs/go-client/command/peers/list"
	"github.com/gitshock-labs/go-client/command/peers/status"
